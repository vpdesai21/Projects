	...
	<div class="rewardPoints">
		...
		<form name="viewAllRewardPoints" method="post" action="<%=application.getContextPath() %>/deleteOrUpdateRewardPoints">
			...
			<table align="center" cellspacing="20">
				...
				<tr>
					<td align="right" style="color:khaki"><b>Select</b></td>
				...
				%>
				<tr>
					<td align="right" ><input type="radio" name="rewardId" id="rewardId" value=<%= rp.getRewardId() %>></input></td>
				...
				<tr>
					<td></td>
					<td></td><td colspan="3">
					<input class="bt" type="button" onClick="sendRedirectPage('delete')" name="delete" value="Delete"/></input>
					</td>
					<td><input type="hidden" name="requestType" value="#"></td>
				</tr>
				<%
				}
				%>
