...
<%@ include file="./header.jsp" %>
	...
	<div style="position:relative; top:-200px; left:100px;">
		<h2 align="center" style="position:relative; top:50px; text-decoration:none;color:lawngreen;">Reward Points Updated Successfully !!</h2>
	...
	<div style="position:relative; top:-100px; left:820px;" >	
